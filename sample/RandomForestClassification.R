...
vehdata <-  read.table("C:\\Users\\Tom Loughin\\Dropbox\\890 Modern Applied Methods\\R\\vehicle3.txt",header=TRUE,sep=" ")
#vehdata <-  read.table("C:\\Users\\Tom Loughin\\Dropbox\\STAT 890\\R\\vehicle3.txt",header=TRUE,sep=" ")
